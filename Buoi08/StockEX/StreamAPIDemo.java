...
public class StreamAPIDemo {
        ...
        private static <T> Predicate<T> distinctByKey(final Function<? super T, String> key) {
                ...
                return t -> {
                        ...
                        /*
                         * This method returns null (if there was no mapping with the provided key
                         * before or it was mapped to a null value)
        ...
        public static void main(String[] args) {
                ...
                // 2.1. Tìm tất cả các giao dịch thực hiện trong năm 2021 và sắp xếp chúng theo
                // số lượng tăng dần.
                // Cách 1
                ...
                // 2.3. Xác định tất cả các khách hàng chung một địa chỉ nào đó, sort by name
                // của khách hàng và in ra.
                ...
                // 2.6. Xác định số lượng (amount) lớn nhất xuất hiện trong các giao dịch và in
                // ra.
                ...
                // 2.7. Tính và in ra tổng số lượng trong các giao dịch của các khách hàng ở một
                // địa chỉ nào đó
